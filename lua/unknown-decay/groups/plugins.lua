...
function M.get(c, config)
  return {
    ...
    -- Gitsigns
    GitSignsAdd = { fg = c.git_add, bg = c.bg_alt },
    GitSignsChange = { fg = c.yellow, bg = c.bg_alt },
    GitSignsDelete = { fg = c.git_delete, bg = c.bg_alt },
    GitSignsAddNr = { fg = c.git_add, bg = c.bg_alt },
    GitSignsChangeNr = { fg = c.yellow, bg = c.bg_alt },
    GitSignsDeleteNr = { fg = c.git_delete, bg = c.bg_alt },
    ...
    GitSignsStagedAdd = { fg = c.git_staged_add, bg = c.bg_alt },
    GitSignsStagedChange = { fg = c.git_staged_mod, bg = c.bg_alt },
    GitSignsStagedDelete = { fg = c.git_staged_del, bg = c.bg_alt },
    GitSignsStagedAddNr = { fg = c.git_staged_add, bg = c.bg_alt },
    GitSignsStagedChangeNr = { fg = c.git_staged_mod, bg = c.bg_alt },
    GitSignsStagedDeleteNr = { fg = c.git_staged_del, bg = c.bg_alt },
